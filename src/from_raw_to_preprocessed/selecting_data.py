## This script allows to select a sample from the global data extracted and preprocessed. It takes as 
...
if __name__ == "__main__":
    ...
    random_data.to_csv("data/cause_random_combined_data_filtered_test.csv", index=False)
